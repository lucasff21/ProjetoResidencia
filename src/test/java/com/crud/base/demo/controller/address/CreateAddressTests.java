...
public class CreateAddressTests {
    ...
    public void beforeAach() throws ResourceNotFoundException, ResourceAlreadyExists {
        addressAlreadyExists = new Address("country", "state", "city", "district", "street", 0, "44380-000", "Casa");
        ...
        addressToCreate = new Address("country1", "state1", "city1", "district1", "street1", 1, "44380-000", "Casa");
    }
