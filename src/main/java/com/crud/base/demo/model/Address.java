...
public class Address {
    ...
    @NotBlank(message = "Apelido is required")
    ...
    public Address(String country, String state, String city, String district, String street, int number, String cep, String apelido){
        this.street = street;
        this.state = state;
